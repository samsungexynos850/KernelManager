 ...
 *
 */
package com.kawa.kernelmanager.fragments.other;
...
import com.kawa.kernelmanager.activities.BannerResizerActivity;
import com.kawa.kernelmanager.activities.MainActivity;
import com.kawa.kernelmanager.activities.NavigationActivity;
import com.kawa.kernelmanager.services.boot.ApplyOnBootService;
import com.kawa.kernelmanager.utils.AppSettings;
import com.kawa.kernelmanager.utils.Themes;
...
import com.kawa.kernelmanager.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                ...
                RootUtils.runCommand("pm clear com.kawa.kernelmanager");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.kernelmanager");
                RootUtils.runCommand("pm clear com.kawa.kernelmanager && reboot");
            });
            alert2.show();
        });
        alert.show();
