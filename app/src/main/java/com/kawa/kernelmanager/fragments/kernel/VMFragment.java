...
import com.kawa.kernelmanager.utils.kernel.vm.VM;
import com.kawa.kernelmanager.utils.kernel.vm.ZRAM;
import com.kawa.kernelmanager.utils.kernel.vm.ZSwap;
// import com.kawa.kernelmanager.utils.kernel.vm.VNSwap;
...
import com.kawa.kernelmanager.views.recyclerview.GenericSelectView2;
import com.kawa.kernelmanager.views.recyclerview.ProgressBarView;
...
public class VMFragment extends RecyclerViewFragment {
    ...
    private void zramInit(List<RecyclerViewItem> items) {
        ...
        int maxZramAllowed = (((int) Device.MemInfo.getInstance().getTotalMem() > 5120) ? 24576 : (int) Device.MemInfo.getInstance().getTotalMem());
