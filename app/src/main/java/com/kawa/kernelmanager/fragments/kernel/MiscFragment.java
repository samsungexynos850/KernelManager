...
import com.kawa.kernelmanager.utils.kernel.misc.Misc;
import com.kawa.kernelmanager.utils.kernel.misc.PowerSuspend;
import com.kawa.kernelmanager.utils.kernel.misc.Pwm;
import com.kawa.kernelmanager.utils.kernel.misc.Selinux;
import com.kawa.kernelmanager.utils.kernel.misc.Vibration;
import com.kawa.kernelmanager.utils.kernel.misc.Wakelocks;
...
public class MiscFragment extends RecyclerViewFragment {
    ...
    private void vibrationInit(List<RecyclerViewItem> items) {
        final Vibrator vibrator = (Vibrator) requireActivity()
    ...
    private void powersuspendInit(List<RecyclerViewItem> items) {
        ...
        if (PowerSuspend.hasMode()) {
            ...
            if (v.contains("1.5") || v.contains("1.8") || v.contains("1.9") || v.contains("2.0") || v.contains("3.0") || v.contains("3.1")) {
