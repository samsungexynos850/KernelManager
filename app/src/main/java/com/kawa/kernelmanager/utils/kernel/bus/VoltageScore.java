 ...
 */
public class VoltageScore {

    public static final String BACKUP = "/data/.kernelmanager/busScore_stock_voltage";

    public static final String SCORE = "/sys/class/devfreq/17000080.devfreq_score";
    public static final String VOLTAGE = SCORE + "/volt_table";
    public static final String TIMESTATES = SCORE + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_SCORE, id, context);
    }
