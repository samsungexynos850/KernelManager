 ...
 *
 */
package com.kawa.kernelmanager.utils.kernel.bus;
 ...
 */
public class VoltageFsys0 {

    public static final String BACKUP = "/data/.kernelmanager/busFsys0_stock_voltage";

    public static final String FSYS0 = "/sys/class/devfreq/17000090.devfreq_fsys0";
    public static final String VOLTAGE = FSYS0 + "/volt_table";
    public static final String TIMESTATES = FSYS0 + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_FSYS0, id, context);
    }
