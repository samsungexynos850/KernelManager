 ...
 */
public class VoltageIva {

    public static final String BACKUP = "/data/.kernelmanager/busIva_stock_voltage";

    public static final String IVA = "/sys/class/devfreq/17000070.devfreq_iva";
    public static final String VOLTAGE = IVA + "/volt_table";
    public static final String TIMESTATES = IVA + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_IVA, id, context);
    }
