 ...
 *
 */
package com.kawa.kernelmanager.utils.kernel.cpuvoltage;
 ...
 */
public class VoltageCl2 {

    public static final String BACKUP = "/data/.kernelmanager/cpuCl2_stock_voltage";

    public static final String CL2_VOLTAGE = "/sys/power/cpucl2volt_table";
    ...
    static {
        sVoltages.put(CL2_VOLTAGE, false);

        sOffsetFreq.put(CL2_VOLTAGE, 1000);

        sOffset.put(CL2_VOLTAGE, 1000);

        sSplitNewline.put(CL2_VOLTAGE, "\\r?\\n");

        sSplitLine.put(CL2_VOLTAGE, " ");

        sAppend.put(CL2_VOLTAGE, false);
    }
    ...
    private static void run(String command, String id, Context context) {
        Control.runSetting(command, ApplyOnBootFragment.CPU_CL2_VOLTAGE, id, context);
    }
