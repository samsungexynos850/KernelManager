 ...
 */
public class VoltageAud {

    public static final String BACKUP = "/data/.kernelmanager/busAud_stock_voltage";

    public static final String AUD = "/sys/class/devfreq/17000060.devfreq_aud";
    public static final String VOLTAGE = AUD + "/volt_table";
    public static final String TIMESTATES = AUD + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_AUD, id, context);
    }
