 ...
 */
public class VoltageIntCam {

    public static final String BACKUP = "/data/.kernelmanager/busIntCam_stock_voltage";

    public static final String CAM = "/sys/class/devfreq/17000030.devfreq_intcam";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_INTCAM, id, context);
    }
