 ...
 */
public class VoltageMfc {

    public static final String BACKUP = "/data/.kernelmanager/busMfc_stock_voltage";

    public static final String MFC = "/sys/class/devfreq/17000090.devfreq_mfc";
    public static final String VOLTAGE = MFC + "/volt_table";
    public static final String TIMESTATES = MFC + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_MFC, id, context);
    }
