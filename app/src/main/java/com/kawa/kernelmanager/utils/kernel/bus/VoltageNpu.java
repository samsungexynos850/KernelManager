 ...
 */
public class VoltageNpu {

    public static final String BACKUP = "/data/.kernelmanager/busNpu_stock_voltage";

    public static final String NPU = "/sys/class/devfreq/170000a0.devfreq_npu";
    public static final String VOLTAGE = NPU + "/volt_table";
    public static final String TIMESTATES = NPU + "/time_in_state";
    ...
    private static void run(String command, String id, Context context) {
        //Control.runSetting(command, ApplyOnBootFragment.BUS_NPU, id, context);
    }
